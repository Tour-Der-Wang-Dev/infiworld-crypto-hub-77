        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="mb-4 sm:mb-0">
            ...
            <ul className="space-y-2 text-sm sm:text-base">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">ข่าวสารและบล็อก</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm sm:text-base">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">ข้อกำหนดการใช้คริปโต</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">การรับรองความปลอดภัย</a></li>
            </ul>
          </div>
        </div>
